...
export const Workspace = () => {
  const { selectNote, setSelectNote, setTitle, setDescription, date, title, description, addNote,openAddForm } =
    ...
    <div className={css.workspace__container}>
      {selectNote ? (
        <form className={css.workspace__form}>
          <p className={css.form__date}>{selectNote?.values?.boWRNdPwndliNcOexcNSkM}</p>
          <input
